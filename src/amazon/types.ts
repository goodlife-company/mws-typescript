...
export enum ReportType { _GET_FLAT_FILE_OPEN_LISTINGS_DATA_, _GET_FLAT_FILE_ORDERS_DATA_, _GET_ORDERS_DATA_, _GET_CONVERGED_FLAT_FILE_ORDER_REPORT_DATA_, _GET_MERCHANT_LISTINGS_ALL_DATA_, _GET_AMAZON_FULFILLED_SHIPMENTS_DATA_};
